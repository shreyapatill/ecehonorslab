...
def bufProcessing2():
    ...
    if 'JV' in Aretes and ALibre != 3 and ALibre != 30:
        reso += bh[ALibre*100 + 3]
    elif 'JO' in Aretes and ALibre != 4 and ALibre != 40:
        reso += bh[ALibre*100 + 4]
    elif 'JB' in Aretes and ALibre != 1 and ALibre != 10:
        reso += bh[ALibre*100 + 1]
    elif 'BO' in Aretes and ALibre != 14 and ALibre != 41:
        reso += bh[ALibre*100 + 14]
    elif 'BR' in Aretes and ALibre != 12 and ALibre != 21:
        reso += bh[ALibre*100 + 12]
    elif 'BBl' in Aretes and ALibre != 15 and ALibre != 51:
        reso += bh[ALibre*100 + 15]
    elif 'RV' in Aretes and ALibre != 23 and ALibre != 32:
        reso += bh[ALibre*100 + 23]
    elif 'RBl' in Aretes and ALibre != 25 and ALibre != 52:
        reso += bh[ALibre*100 + 25]
    elif 'VO' in Aretes and ALibre != 34 and ALibre != 43:
        reso += bh[ALibre*100 + 34]
    elif 'OBl' in Aretes and ALibre != 45 and ALibre != 54:
        reso += bh[ALibre*100 + 45]
    elif 'VBl' in Aretes and ALibre != 35 and ALibre != 53:
...
def getSolution(cubeString):
    ...
    finalCube = [c[0],c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8],
                ...
                c[15],c[16],c[17],c[27],c[28],c[29],c[39],c[40],c[41],
